...
Heap* criarHeap(int array[], int tamanho, PerformanceStats *stats) {
    ...
    // Alocar espaço para dados, tamanho+1 para índice 1-based
    heap->dados = malloc((tamanho + 1) * sizeof(int));
    stats->memory_allocations++;

    // Copiar elementos do array para heap->dados com offset 1
